...
public abstract class Visitor {
  ...
  public abstract void visit(ArrayInitializer initializer);

  public abstract void visit(ArrayAccess arrayAccess);

  public abstract void visit(ArrayLength length);

  public abstract void visit(ArrayAssignment assignment);
}
